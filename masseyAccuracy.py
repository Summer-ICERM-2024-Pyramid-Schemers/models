...
def plot_accuracy():
    ...
    plt.tight_layout()
    plt.grid(True)
    savefig_to_images_dir("massey_accuracy_line.png")
    ...
    plt.tight_layout()
    plt.grid(True)
    savefig_to_images_dir("weighted_massey_accuracy_line.png")
    ...
    savefig_to_images_dir("massey_accuracy_bar.png")
    ...
    #plt.xticks(rotation=45)
    plt.grid(True, axis='y')
    savefig_to_images_dir("weighted_massey_accuracy_bar.png")
