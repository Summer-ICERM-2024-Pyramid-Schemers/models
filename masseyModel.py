...
class MasseyModel(BaseModel):
    ...
    def _get_model_by_season(cls, season):
        ...
        """
        Games, marketValues = fetch_data_for_massey_model()

        pre_Games = Games.loc[Games['season'] < season, :]

        # get Massey ratings using 
        massey_ratings = MasseyEngine.get_ratings(goals_home=pre_Games['fulltime_home_goals'], 
